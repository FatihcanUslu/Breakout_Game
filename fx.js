class Fx {
    ...
    drawCircle(x,y, width,height, color) {
        ...
        this.context.arc(x, y, width-7, 0, 2 * Math.PI, false);
        this.context.fill();
        this.context.stroke();
    }
    ...
    drawPoint(x,y,color,point) {
        this.context.font = "30px Arial";
        this.context.fillStyle = color;
        this.context.fillText("Point: "+point, x, y);
        //this.context.fillRect(x,y, width,height);
    }

    drawLife(x,y,color,life) {
        this.context.font = "30px Arial";
        this.context.fillStyle = color;
        this.context.fillText("Life: "+life, x, y);
        //this.context.fillRect(x,y, width,height);
    }
} 
